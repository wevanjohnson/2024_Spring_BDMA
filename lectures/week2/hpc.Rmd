...
![](figs/hpc/ondemand_files.png)

## Accessing the Terminal
![](figs/hpc/ondemand_terminal_1.png)

![](figs/hpc/ondemand_terminal_2.png)

## Accessing the Amarel Desktop through OnDemand
![](figs/hpc/ondemand_desktop_1.png)

## Accessing the Amarel Desktop through OnDemand
![](figs/hpc/ondemand_desktop_2.png)

## Accessing the Amarel Desktop through OnDemand
![](figs/hpc/ondemand_desktop_3.png)


## Accessing the Amarel Desktop through OnDemand
![](figs/hpc/ondemand_desktop_4.png)

## Accessing the Amarel Desktop through OnDemand
![](figs/hpc/ondemand_desktop_5.png)

## Accessing the Amarel Desktop through OnDemand
![](figs/hpc/ondemand_desktop_6.png)
...
![](figs/hpc/ondemand_rstudio_1.png)

## Accessing the RStudio through OnDemand
\center
![](figs/hpc/ondemand_rstudio_2.png){width=80%}

## Accessing the RStudio through OnDemand
![](figs/hpc/ondemand_rstudio_3.png)

## Accessing the RStudio through OnDemand
![](figs/hpc/ondemand_rstudio_4.png)

## Accessing the RStudio through OnDemand
![](figs/hpc/ondemand_rstudio_5.png)
